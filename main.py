...
def main():
    try:
        ...
        st.title(f"🧙🔮🤖 Elysium Task Wizard ✨🪄 Made Just for {DEFAULT_INVESTOR}")
        st.markdown(
            """
        ...
        if openai_api_key:
            ...
            OBJECTIVE = st.text_input(
                ...
                value="Redefine the NY Jets fan experience for maximum engagement.",
            )
            ...
            first_task = st.text_input(
                ...
                value="Perform analysis on NY Jet's stadium amenities and spotlight in-game entertainment.",
            )
